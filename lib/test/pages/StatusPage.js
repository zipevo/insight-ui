...
function StatusPage(driver) {
  ...
  const version = driver.findElement(By.xpath("//h2[contains(text(), 'Zip node information')]/../table//tr[1]//td[2]"));
  const protocolVersion = driver.findElement(By.xpath("//h2[contains(text(), 'Zip node information')]/../table//tr[2]//td[2]"));
  const blocks = driver.findElement(By.xpath("//h2[contains(text(), 'Zip node information')]/../table//tr[3]//td[2]"));
  const timeOffset = driver.findElement(By.xpath("//h2[contains(text(), 'Zip node information')]/../table//tr[4]//td[2]"));
  const connections = driver.findElement(By.xpath("//h2[contains(text(), 'Zip node information')]/../table//tr[5]//td[2]"));
  const miningDifficulty = driver.findElement(By.xpath("//h2[contains(text(), 'Zip node information')]/../table//tr[6]//td[2]"));
  const network = driver.findElement(By.xpath("//h2[contains(text(), 'Zip node information')]/../table//tr[7]//td[2]"));
  const proxySetting = driver.findElement(By.xpath("//h2[contains(text(), 'Zip node information')]/../table//tr[8]//td[2]"));
  const infoErrors = driver.findElement(By.xpath("//h2[contains(text(), 'Zip node information')]/../table//tr[9]//td[2]"));
